...
def split_data(data_dir, csv_name, category_num, split_ratio, aug_num):
    ...
    print('New Data Size:', train_df.shape[0], 'validation', valid_df.shape[0])
...
#             total_loss.backward() 
        ...
        val_total_size, mae_loss = valid_fn(net=net, val_loader=val_loader, Fine_C=Fine_C, Coarse_C=Coarse_C, devices=devices)
...
def valid_fn(*, net, val_loader, Fine_C, Coarse_C, devices):
